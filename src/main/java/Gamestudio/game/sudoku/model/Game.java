package Gamestudio.game.sudoku.model;
...
public class Game extends Observable {
	...
	/**
	 * Returns next posible number from list for given position or -1 when list is
	 * empty.
	 *
	 * @param game
	 *            Game to check.
	 ...
	 * @return Next possible number for position in game or -1 when list is empty.
	 */
	...
	/**
	 * Generates Sudoku game from solution, user should use the other generateGame
	 * method. This method simple removes a number at a position. If the game isn't
	 * anymore valid after this action, the game will be brought back to previous
	 * state.
	 *
	 * @param game
	...
	/**
	 * Checks whether given game is valid, user should use the other isValid method.
	 ...
	 *            Number of found solutions. Int[] instead of int because of pass by
	 *            reference.
	 * @return True if game is valid, false otherwise.
	 */
	 ...
	 *
	 * private void print(int[][] game) { System.out.println(); for (int y = 0; y <
	 * 9; y++) { for (int x = 0; x < 9; x++) System.out.print(" " + game[y][x]);
	 * System.out.println(); } }
	 */
}